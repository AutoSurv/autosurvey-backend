...
public class CountryConverter {
    ...
    public static OrgCountryDTO toResponseDto(CountryGroup country) {
        return  new OrgCountryDTO(country.getCountryId(), country.getCountry(), country.getOrgId(), country.getOrgName());
